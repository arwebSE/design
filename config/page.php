...
return [
    ...
    "views" => [
        [
            ...
            "data" => [
                "class" => "large",
                "siteLogo"      => "image/theme/arcircle.png?width=150&height=150",
                "siteLogoAlt"   => "Min logga",
            ],
        ],
        [
            "region" => "header-col-1",
            ...
            "data" => [
                "homeLink"      => "",
                "siteLogoText"  => "design",
                "siteLogoTextIcon" => "image/theme/arcircle.png?width=40&height=40",
                "siteLogoTextIconAlt" => "Liten logga",
            ],
        ],
        [
            "region" => "header-col-2",
